...
# - 1 On the seventh incorrect guess, the player loses the game (display a message and break out of the loop).
# - 2 On revealing the entire word, the player wins the game (display a message and break out of the loop).
# - 3 You should validate that the input is valid: must be one letter, a to z. Be sure to handle capital letters, but I'll leave how up to you. If the input is invalid, tell the player.
